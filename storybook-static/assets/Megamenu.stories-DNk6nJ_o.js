import{d as s}from"./sitedata-kjDPmuCf.js";const l=({data:i})=>{const a=document.createElement("nav");a.className="qld__main-nav qld__main-nav--mega",a.id="mainmenu",a.label="main";const e=`
  ...
  `;return a.innerHTML=e,a},t={title:"Layout/Mega Menu",tags:["autodocs"],render:i=>l(i),parameters:{layout:"padded"},argTypes:{},args:{data:s}},n={};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"{}",...n.parameters?.docs?.source}}};const d=["Megamenu"];export{n as Megamenu,d as __namedExportsOrder,t as default};

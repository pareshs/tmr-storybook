const l=({data:n})=>{const a=document.createElement("nav");a.className="qld__main-nav qld__main-nav--mega",a.id="mainmenu",a.label="main";const i=`
  ...
  `;return a.innerHTML=i,a};export{l as c};
